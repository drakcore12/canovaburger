...
const products = [
  { id:"sinverguenza", category:"burgers", tag:{es:"LA CLÁSICA",en:"THE CLASSIC"}, name:{es:"La Sin Vergüenza",en:"La Sin Vergüenza"}, description:{es:"Doble smash, doble queso American, pepinillos, cebolla a la plancha y Canova Sauce.",en:"Double smash, double American cheese, pickles, grilled onion and Canova Sauce."}, price:9.49, appPrice:10.99, art:"classic", image:"assets/products/la-sin-verguenza.png" },
  { id:"miamicriminal", category:"burgers", tag:{es:"SABOR MIAMI",en:"MIAMI FLAVOR"}, name:{es:"La Miami Criminal",en:"La Miami Criminal"}, description:{es:"Doble smash, queso suizo, jamón crujiente, cebolla, pepinillos, papitas finas y Mojo Mustard Sauce.",en:"Double smash, Swiss cheese, crispy ham, onion, pickles, shoestring potatoes and Mojo Mustard Sauce."}, price:11.99, appPrice:13.49, art:"miami", image:"assets/products/la-miami-criminal.png" },
  { id:"colesterol", category:"burgers", tag:{es:"SIN LÍMITES",en:"NO LIMITS"}, name:{es:"La Colesterol",en:"La Colesterol"}, description:{es:"Doble smash, cheddar, tocineta, cebolla caramelizada, huevo frito y Canova Sauce. No vino a cuidarte. Vino a hacerte feliz.",en:"Double smash, cheddar, bacon, caramelized onion, fried egg and Canova Sauce. It came to make you happy."}, price:12.99, appPrice:14.49, art:"colesterol", image:"assets/products/la-colesterol.png" },
  { id:"lemonrush", category:"sides", tag:{es:"FRENCH / CRIOLLA",en:"FRENCH / CRIOLLA"}, name:{es:"Lemon Rush",en:"Lemon Rush"}, description:{es:"Limón fresco, sal y sazón cítrica Canova. Criolla Mode +$1.00.",en:"Fresh lime, salt and Canova citrus seasoning. Criolla Mode +$1.00."}, price:4.49, art:"fries", image:"assets/products/lemon-rush.png" },
  { id:"bravaheat", category:"sides", tag:{es:"PICANTE MODERADO",en:"MEDIUM HEAT"}, name:{es:"Brava Heat",en:"Brava Heat"}, description:{es:"Salsa brava, mayonesa de ajo y paprika ahumada. Criolla Mode +$1.00.",en:"Brava sauce, garlic mayo and smoked paprika. Criolla Mode +$1.00."}, price:5.49, art:"fries", image:"assets/products/brava-heat.png" },
  { id:"cheesedust", category:"sides", tag:{es:"QUESO INTENSO",en:"CHEESY"}, name:{es:"Cheese Dust",en:"Cheese Dust"}, description:{es:"Queso en polvo y sazón especial Canova. Criolla Mode +$1.00.",en:"Cheese powder and Canova seasoning. Criolla Mode +$1.00."}, price:4.99, art:"fries", image:"assets/products/cheese-dust.png" },
  { id:"makecombo", category:"combos", tag:{es:"AGRÉGALO",en:"ADD IT"}, name:{es:"Make It a Combo",en:"Make It a Combo"}, description:{es:"Añade papas French Mode y bebida a cualquier hamburguesa. Cambio a Criolla Mode +$1.00.",en:"Add French Mode fries and a drink to any burger. Upgrade to Criolla Mode +$1.00."}, price:4.49, art:"combo", image:"assets/products/make-it-a-combo.png" },
  { id:"canovasauce", category:"sauces", tag:{es:"DE LA CASA",en:"HOUSE SAUCE"}, name:{es:"Canova Sauce",en:"Canova Sauce"}, description:{es:"Cremosa, ligeramente dulce, ácida y ahumada.",en:"Creamy, lightly sweet, tangy and smoky."}, price:0.75, art:"sauce", image:"assets/products/canova-sauce.png" },
  { id:"mojomustard", category:"sauces", tag:{es:"CÍTRICA",en:"CITRUS"}, name:{es:"Mojo Mustard Sauce",en:"Mojo Mustard Sauce"}, description:{es:"Mostaza cremosa, ajo, cítrico y especias.",en:"Creamy mustard, garlic, citrus and spices."}, price:0.75, art:"sauce", image:"assets/products/mojo-mustard-sauce.png" },
  { id:"spicycanova", category:"sauces", tag:{es:"PICANTE",en:"SPICY"}, name:{es:"Spicy Canova",en:"Spicy Canova"}, description:{es:"La Canova Sauce con un golpe extra de intensidad.",en:"Canova Sauce with an extra hit of heat."}, price:0.75, art:"sauce", image:"assets/products/spicy-canova.png" },
  { id:"soda", category:"drinks", tag:{es:"BIEN FRÍA",en:"ICE COLD"}, name:{es:"Soda",en:"Soda"}, description:{es:"Coca-Cola, Coca-Cola Zero o Sprite.",en:"Coca-Cola, Coca-Cola Zero or Sprite."}, price:2.49, art:"drink", image:"assets/products/soda.png" },
  { id:"water", category:"drinks", tag:{es:"FRÍA",en:"COLD"}, name:{es:"Agua",en:"Water"}, description:{es:"Agua embotellada.",en:"Bottled water."}, price:1.99, art:"drink", image:"assets/products/agua.png" },
  { id:"tentacion", category:"desserts", tag:{es:"SWEET ENDING",en:"SWEET ENDING"}, name:{es:"La Tentación",en:"La Tentación"}, description:{es:"Brownie intenso de chocolate con salsa de chocolate o dulce de leche.",en:"Rich chocolate brownie with chocolate or dulce de leche sauce."}, price:4.99, art:"dessert", image:"assets/products/la-tentacion.png" },
];
...
function renderProducts(){
  ...
  products.filter(p=>activeFilter==="all"||p.category===activeFilter).forEach((product,index)=>{
    ...
    if(product.image){photo.src=product.image;photo.alt=product.name[language];card.querySelector(".mini-burger").hidden=true}
